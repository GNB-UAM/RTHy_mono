...
if version=='one_test':
	#early = 15
	plt.plot(periodoLP, PDtoLP, 'o', label="With 1stLP to 1stDP")
	plt.plot(periodoLP, delay, 'ro', label="With delay")
	plt.xlabel("Period")
	plt.ylabel("")
	plt.title("Invariant")
...
slope, intercept, r_value2, p_value, std_err = stats.linregress(periodoLP, delay)
